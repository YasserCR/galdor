...
require (
	github.com/YasserCR/galdor v1.5.0
	github.com/YasserCR/galdor/providerset v1.5.0
	github.com/goccy/go-yaml v1.19.2
	go.opentelemetry.io/otel/sdk v1.43.0
)

require (
	github.com/YasserCR/galdor/providers/anthropic v1.5.0 // indirect
	github.com/YasserCR/galdor/providers/bedrock v1.5.0 // indirect
	github.com/YasserCR/galdor/providers/google v1.5.0 // indirect
	github.com/YasserCR/galdor/providers/openai v1.5.0 // indirect
