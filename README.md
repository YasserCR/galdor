...
**`v0.6.1` tagged. Looking for early integrators.**
...
```bash
go get github.com/YasserCR/galdor@v0.6.1
# plus the provider(s) you need:
go get github.com/YasserCR/galdor/providers/anthropic@v0.6.1
go get github.com/YasserCR/galdor/providers/openai@v0.6.1
# or pick a provider at runtime via env var:
go get github.com/YasserCR/galdor/providerset@v0.6.1
```
...
```bash
go install github.com/YasserCR/galdor/cmd/galdor@v0.6.1
