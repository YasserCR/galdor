...
**`v0.6.2` tagged. Looking for early integrators.**
...
```bash
go get github.com/YasserCR/galdor@v0.6.2
# plus the provider(s) you need:
go get github.com/YasserCR/galdor/providers/anthropic@v0.6.2
go get github.com/YasserCR/galdor/providers/openai@v0.6.2
# or pick a provider at runtime via env var:
go get github.com/YasserCR/galdor/providerset@v0.6.2
```
...
```bash
go install github.com/YasserCR/galdor/cmd/galdor@v0.6.2
