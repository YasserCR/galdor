...
require (
	github.com/YasserCR/galdor v0.9.0
	github.com/YasserCR/galdor/providers/anthropic v0.9.0
	github.com/YasserCR/galdor/providers/bedrock v0.9.0
	github.com/YasserCR/galdor/providers/google v0.9.0
	github.com/YasserCR/galdor/providers/openai v0.9.0
