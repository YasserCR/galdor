...
require (
	github.com/YasserCR/galdor v0.6.0
	github.com/YasserCR/galdor/providers/anthropic v0.6.0
	github.com/YasserCR/galdor/providers/bedrock v0.6.0
	github.com/YasserCR/galdor/providers/google v0.6.0
	github.com/YasserCR/galdor/providers/openai v0.6.0
