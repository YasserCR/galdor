...
require (
	...
	github.com/YasserCR/galdor/providers/anthropic v0.15.1
	github.com/YasserCR/galdor/providers/bedrock v0.15.1
	github.com/YasserCR/galdor/providers/google v0.15.1
	github.com/YasserCR/galdor/providers/openai v0.15.1
