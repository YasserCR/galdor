...
require (
	...
	github.com/YasserCR/galdor/providers/anthropic v0.14.0
	github.com/YasserCR/galdor/providers/bedrock v0.14.0
	github.com/YasserCR/galdor/providers/google v0.14.0
	github.com/YasserCR/galdor/providers/openai v0.14.0
