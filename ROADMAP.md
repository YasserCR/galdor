...
- [x] AWS Bedrock adapter — `providers/bedrock` (Converse API; uses AWS SDK Go v2 for SigV4 and Event Stream framing; validated against a live AWS account, including streamed extended-thinking via a `global.` inference profile)
